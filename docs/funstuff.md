...
### Other useful tools
* [Find undocumented APIs](https://inspectelement.org/apis)
* [Regexr](https://regexr.com/)
* [CURL converter](https://curlconverter.com/)
* [Web app for OCR](https://webbrowsertools.com/image-reader/)
* [Web plot digitizer (get data points from images)](https://automeris.io/WebPlotDigitizer.html/)
* [Exodus privacy for auditing android apps](https://reports.exodus-privacy.eu.org/en/)
